(function () {
    ...
    function makeStrip(param, settings, setParam) {
        ...
        wrap.className = 'fdgb-comp-strip';
        wrap.style.setProperty('--value', String(ratio));

        const label = document.createElement('span');
        label.className = 'fdgb-comp-label';
        label.textContent = param.label || param.id;
        const meter = document.createElement('span');
        meter.className = 'fdgb-comp-meter';
        const fill = document.createElement('span');
        fill.className = 'fdgb-comp-fill';
        meter.append(fill);
        const readout = document.createElement('span');
        readout.className = 'fdgb-comp-readout';
        readout.textContent = format(current, param);
        const input = document.createElement('input');
        input.className = 'fdgb-comp-range';
        input.type = 'range';
...
.fdgb-comp-title span:last-child {
...
`,
        ...
        renderGui(api) {
            ...
            root.className = 'fdgb-comp-panel';
            const title = document.createElement('div');
            title.className = 'fdgb-comp-title';
            title.innerHTML = '<span>compressor</span><span>dynamics desk</span>';
            const grid = document.createElement('div');
            grid.className = 'fdgb-comp-grid';
