...
.fdgb-speed-title span:last-child {
    color: #ffd666;
}
.fdgb-speed-main {
    display: grid;
...
.fdgb-speed-card input[type="range"] {
    --value: 0.23;
    width: 100%;
    height: 12px;
    appearance: none;
...
.fdgb-speed-card input[type="range"]::-webkit-slider-thumb {
    appearance: none;
    width: 20px;
    height: 20px;
...
.fdgb-speed-card input[type="range"]::-moz-range-thumb {
    width: 18px;
    height: 18px;
    border: 2px solid #07130e;
    border-radius: 50%;
...
`,
        ...
        renderGui(api) {
            ...
            syncCard.className = 'fdgb-speed-card';
            const checkLabel = document.createElement('label');
            checkLabel.className = 'fdgb-speed-check';
            ...
            bpmRow.className = 'fdgb-speed-row';
            const bpmLabel = document.createElement('span');
            bpmLabel.textContent = 'sample bpm';
            const bpmInput = document.createElement('input');
            bpmInput.className = 'fdgb-speed-text';
            bpmInput.type = 'text';
