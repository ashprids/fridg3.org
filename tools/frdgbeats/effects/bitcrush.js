(function () {
    ...
    function makeLed(param, settings, setParam) {
        ...
        chips.className = 'fdgb-crush-chips';
...
.fdgb-crush-title span:last-child {
...
.fdgb-crush-chips span {
    height: 12px;
    border: 1px solid rgba(216, 199, 255, 0.24);
    background: rgba(255, 255, 255, 0.04);
}
.fdgb-crush-chips span.is-lit {
    background: #aeea88;
...
`,
        ...
        renderGui(api) {
            ...
            root.className = 'fdgb-crush-panel';
            const title = document.createElement('div');
            title.className = 'fdgb-crush-title';
            title.innerHTML = '<span>bitcrush</span><span>sample mangler</span>';
            const grid = document.createElement('div');
            grid.className = 'fdgb-crush-grid';
