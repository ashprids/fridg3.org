(function () {
    ...
    function makeKnob(param, settings, setParam) {
        ...
        wrap.className = 'fdgb-delay-knob';

        const dial = document.createElement('span');
        dial.className = 'fdgb-delay-dial';
        ...
        title.className = 'fdgb-delay-label';
        title.textContent = param.label || param.id;
        const readout = document.createElement('span');
        readout.className = 'fdgb-delay-readout';

        if (param.type === 'select') {
            const select = input;
            select.className = 'fdgb-delay-select';
        ...
        input.className = 'fdgb-delay-hidden-range';
        input.type = 'range';
...
.fdgb-delay-title span:last-child {
...
`,
        ...
        renderGui(api) {
            ...
            root.className = 'fdgb-delay-console';
            const title = document.createElement('div');
            title.className = 'fdgb-delay-title';
            title.innerHTML = '<span>clockwork delay</span><span>bpm locked</span>';
            const knobs = document.createElement('div');
            knobs.className = 'fdgb-delay-knobs';
