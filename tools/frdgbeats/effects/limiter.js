(function () {
    ...
    function makeControl(param, settings, setParam) {
        ...
        wrap.className = 'fdgb-limit-control';
...
.fdgb-limit-title span:last-child {
...
.fdgb-limit-control span,
.fdgb-limit-control strong {
    overflow: hidden;
...
`,
        ...
        renderGui(api) {
            ...
            root.className = 'fdgb-limit-panel';
            const title = document.createElement('div');
            title.className = 'fdgb-limit-title';
            title.innerHTML = '<span>limiter</span><span>brickwall</span>';
            const grid = document.createElement('div');
            grid.className = 'fdgb-limit-grid';
