(function () {
    ...
    function makePad(param, settings, setParam) {
        ...
        wrap.className = 'fdgb-dist-pad';
        wrap.style.setProperty('--value', String(ratio));

        const meter = document.createElement('span');
        meter.className = 'fdgb-dist-meter';
        const spark = document.createElement('span');
        spark.className = 'fdgb-dist-spark';
        meter.append(spark);

        const label = document.createElement('span');
        label.className = 'fdgb-dist-label';
        label.textContent = param.label || param.id;

        const value = document.createElement('span');
        value.className = 'fdgb-dist-value';
        value.textContent = readout(current, param);

        const input = document.createElement('input');
        input.className = 'fdgb-dist-range';
        input.type = 'range';
    ...
    function makeSelectPad(param, settings, setParam) {
        const wrap = document.createElement('label');
        wrap.className = 'fdgb-dist-pad fdgb-dist-select-pad';
        const meter = document.createElement('span');
        meter.className = 'fdgb-dist-meter';
        const spark = document.createElement('span');
        spark.className = 'fdgb-dist-spark';
        ...
        select.className = 'fdgb-dist-select';
...
.fdgb-dist-title span:last-child {
...
.fdgb-dist-select-pad .fdgb-dist-meter {
    height: 20px;
}
...
`,
        ...
        renderGui(api) {
            ...
            root.className = 'fdgb-dist-console';
            const title = document.createElement('div');
            title.className = 'fdgb-dist-title';
            title.innerHTML = '<span>hot circuit</span><span>waveshaper</span>';
            const pads = document.createElement('div');
            pads.className = 'fdgb-dist-pads';
