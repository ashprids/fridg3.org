(function () {
    ...
    const DEFAULT_SOUNDFONT_URL = '/tools/frdgbeats/soundfonts/Roland_SC-55.sf2';
    const SOUNDFONT_LIST_URL = '/tools/frdgbeats/soundfonts/index.php';
    const SAMPLE_LIST_URL = '/tools/frdgbeats/samples/index.php';
    const DEMO_LIST_URL = '/tools/frdgbeats/demos/index.php';
    const PRESET_LIST_URL = '/tools/frdgbeats/presets/index.php';
    ...
    const els = {
        ...
        play: document.getElementById('fdgb-play'),
        stop: document.getElementById('fdgb-stop'),
        record: document.getElementById('fdgb-record'),
        openCredits: document.getElementById('fdgb-open-credits'),
        openWiki: document.getElementById('fdgb-open-wiki'),
        projectName: document.getElementById('fdgb-project-name'),
        bpm: document.getElementById('fdgb-bpm'),
        status: document.getElementById('fdgb-status'),
        meterL: document.getElementById('fdgb-meter-l'),
        meterR: document.getElementById('fdgb-meter-r'),
        masterVolume: document.getElementById('fdgb-master-volume'),
        waveform: document.getElementById('fdgb-waveform'),
        channelList: document.getElementById('fdgb-channel-list'),
        addChannel: document.getElementById('fdgb-add-channel'),
        pianoRoll: document.getElementById('fdgb-piano-roll'),
        selectedLabel: document.getElementById('fdgb-selected-label'),
        pattern: document.getElementById('fdgb-pattern'),
        patternSteps: document.getElementById('fdgb-pattern-steps'),
        octave: document.getElementById('fdgb-octave'),
        noteSnap: document.getElementById('fdgb-note-snap'),
        octaveDown: document.getElementById('fdgb-octave-down'),
        octaveUp: document.getElementById('fdgb-octave-up'),
        clearPattern: document.getElementById('fdgb-clear-pattern'),
        rollTab: document.getElementById('fdgb-roll-tab'),
        playlistTab: document.getElementById('fdgb-playlist-tab'),
        mixerTab: document.getElementById('fdgb-mixer-tab'),
        automationTab: document.getElementById('fdgb-automation-tab'),
        waveformTab: document.getElementById('fdgb-waveform-tab'),
        synthTab: document.getElementById('fdgb-synth-tab'),
        rollView: document.getElementById('fdgb-roll-view'),
        playlistView: document.getElementById('fdgb-playlist-view'),
        mixerView: document.getElementById('fdgb-mixer-view'),
        automationView: document.getElementById('fdgb-automation-view'),
        waveformView: document.getElementById('fdgb-waveform-view'),
        synthView: document.getElementById('fdgb-synth-view'),
        mixer: document.getElementById('fdgb-mixer'),
        mixerLabel: document.getElementById('fdgb-mixer-label'),
        automationLabel: document.getElementById('fdgb-automation-label'),
        automationPattern: document.getElementById('fdgb-automation-pattern'),
        automationTarget: document.getElementById('fdgb-automation-target'),
        addAutomation: document.getElementById('fdgb-add-automation'),
        automation: document.getElementById('fdgb-automation'),
        waveformLabel: document.getElementById('fdgb-waveform-label'),
        synthLabel: document.getElementById('fdgb-synth-label'),
        synthEditor: document.getElementById('fdgb-synth-editor'),
        sampleZoomOut: document.getElementById('fdgb-sample-zoom-out'),
        sampleZoomReset: document.getElementById('fdgb-sample-zoom-reset'),
        sampleZoomIn: document.getElementById('fdgb-sample-zoom-in'),
        sampleScroll: document.getElementById('fdgb-sample-scroll'),
        removeSampleZone: document.getElementById('fdgb-remove-sample-zone'),
        sampleCanvas: document.getElementById('fdgb-sample-canvas'),
        sampleEditorStatus: document.getElementById('fdgb-sample-editor-status'),
        effectPicker: document.getElementById('fdgb-effect-picker'),
        addEffect: document.getElementById('fdgb-add-effect'),
        playlist: document.getElementById('fdgb-playlist'),
        playlistTools: document.getElementById('fdgb-playlist-tools'),
        clearPlaylist: document.getElementById('fdgb-clear-playlist'),
        save: document.getElementById('fdgb-save'),
        load: document.getElementById('fdgb-load'),
        newProject: document.getElementById('fdgb-new-project'),
        presetsMenu: document.getElementById('fdgb-presets-menu'),
        demosMenuButton: document.getElementById('fdgb-demos-menu-button'),
        demosMenu: document.getElementById('fdgb-demos-menu'),
        globalSoundfont: document.getElementById('fdgb-global-soundfont'),
        soundfontMenu: document.getElementById('fdgb-soundfont-menu'),
        importProject: document.getElementById('fdgb-import-project'),
        exportProject: document.getElementById('fdgb-export-project'),
        importMidi: document.getElementById('fdgb-import-midi'),
        exportMidi: document.getElementById('fdgb-export-midi'),
        exportWav: document.getElementById('fdgb-export-wav'),
        importMenuButton: document.getElementById('fdgb-import-menu-button'),
        exportMenuButton: document.getElementById('fdgb-export-menu-button'),
        importMenu: document.getElementById('fdgb-import-menu'),
        exportMenu: document.getElementById('fdgb-export-menu'),
        projectFile: document.getElementById('fdgb-project-file'),
        midiFile: document.getElementById('fdgb-midi-file'),
        globalSoundfontFile: document.getElementById('fdgb-global-soundfont-file')
    };
    ...
    function syncGlobalSoundfontButton() {
        ...
        if (!enabled && els.soundfontMenu) els.soundfontMenu.classList.add('fdgb-hidden');
    }
    ...
    function registerEffect(definition) {
        ...
        if (definition.css && !document.getElementById('fdgb-effect-style-' + definition.id)) {
            const style = document.createElement('style');
            style.id = 'fdgb-effect-style-' + definition.id;
    ...
    function registerSynth(definition) {
        ...
        if (definition.css && !document.getElementById('fdgb-synth-style-' + definition.id)) {
            const style = document.createElement('style');
            style.id = 'fdgb-synth-style-' + definition.id;
            style.textContent = definition.css;
            document.head.append(style);
        }
        state.channels.forEach(channel => {
    ...
    function showExportProgress(title, detail = '') {
        ...
        overlay.className = 'fdgb-export-overlay';
        overlay.setAttribute('role', 'status');
        overlay.setAttribute('aria-live', 'polite');
        overlay.innerHTML = '<div class="fdgb-export-dialog"><div class="fdgb-export-title"></div><div class="fdgb-export-detail-row"><div class="fdgb-export-detail"></div><div class="fdgb-export-percent">0%</div></div></div>';
        const titleEl = overlay.querySelector('.fdgb-export-title');
        const detailEl = overlay.querySelector('.fdgb-export-detail');
        const percentEl = overlay.querySelector('.fdgb-export-percent');
    ...
    function showConfirmDialog(title, detail, confirmText = 'confirm', cancelText = 'cancel') {
        ...
        return new Promise(resolve => {
            const overlay = document.createElement('div');
            overlay.className = 'fdgb-export-overlay fdgb-confirm-overlay';
            overlay.setAttribute('role', 'dialog');
            overlay.setAttribute('aria-modal', 'true');
            overlay.innerHTML = '<div class="fdgb-export-dialog fdgb-confirm-dialog"><div class="fdgb-export-title"></div><div class="fdgb-confirm-detail"></div><div class="fdgb-confirm-actions"><button class="fdgb-button fdgb-confirm-cancel" type="button"></button><button class="fdgb-button fdgb-confirm-ok" type="button"></button></div></div>';
            const titleEl = overlay.querySelector('.fdgb-export-title');
            const detailEl = overlay.querySelector('.fdgb-confirm-detail');
            const cancel = overlay.querySelector('.fdgb-confirm-cancel');
            const ok = overlay.querySelector('.fdgb-confirm-ok');
            titleEl.textContent = title;
            detailEl.textContent = detail;
    ...
    function renderCreditsMarkdown(markdown) {
        ...
        for (let index = 0; index < lines.length; index++) {
            ...
            if (unordered) {
                ...
                if (task) {
                    html.push('<li class="fdgb-credits-task"><input type="checkbox" disabled' + (task[1].toLowerCase() === 'x' ? ' checked' : '') + '> ' + renderCreditsInline(task[2].trim()) + '</li>');
                } else {
        ...
        flushParagraph();
        closeList();
        return html.join('\n') || '<p class="fdgb-credits-empty">credits.md is empty right now.</p>';
    }

    async function showCreditsDialog() {
        const overlay = document.createElement('div');
        overlay.className = 'fdgb-export-overlay fdgb-credits-overlay';
        overlay.setAttribute('role', 'dialog');
        overlay.setAttribute('aria-modal', 'true');
        overlay.innerHTML = '<div class="fdgb-export-dialog fdgb-credits-dialog"><button class="fdgb-button fdgb-credits-close" type="button" data-tooltip="close"><i class="fa-solid fa-xmark"></i></button><div class="fdgb-credits-body"><p class="fdgb-credits-empty">loading credits...</p></div></div>';
        const body = overlay.querySelector('.fdgb-credits-body');
        const closeButton = overlay.querySelector('.fdgb-credits-close');
        const onKeydown = event => {
        ...
        try {
            const response = await fetch('/tools/frdgbeats/credits.md', { cache: 'no-store' });
            if (!response.ok) throw new Error('credits load failed');
            body.innerHTML = renderCreditsMarkdown(await response.text());
        } catch (_) {
            body.innerHTML = '<p class="fdgb-credits-empty">credits.md could not be loaded.</p>';
        }
    }
    ...
    function renderChannels() {
        ...
        state.channels.forEach((channel, channelIndex) => {
            ...
            card.className = 'fdgb-channel'
                + (channel.id === selectedId ? ' is-selected' : '')
                + (collapsed ? ' is-collapsed' : '');
            card.dataset.channelId = channel.id;

            const head = document.createElement('div');
            head.className = 'fdgb-channel-head';

            const color = document.createElement('input');
            color.className = 'fdgb-color-input';
            color.type = 'color';
            ...
            name.className = 'fdgb-channel-name';
            ...
            name.addEventListener('click', event => {
                ...
                root.querySelectorAll('.fdgb-channel').forEach(el => el.classList.toggle('is-selected', el.dataset.channelId === channel.id));
                renderRoll();
                name.readOnly = false;
                name.focus();
                name.select();
            ...
            remove.classList.add('fdgb-remove-button');
            ...
            expand.classList.add('fdgb-channel-expand-button');
    ...
    function miniButton(text, label, active) {
        const button = document.createElement('button');
        button.className = 'fdgb-button fdgb-mini-button' + (active ? ' is-active' : '');
        button.type = 'button';
    ...
    function miniField(labelText, control) {
        ...
        wrap.className = 'fdgb-mini-field';
    ...
    function sampleKeepDurationField(channel) {
        const wrap = document.createElement('label');
        wrap.className = 'fdgb-field fdgb-checkbox-field';
        wrap.addEventListener('click', event => event.stopPropagation());
        const text = document.createElement('span');
        text.className = 'fdgb-checkbox-label';
        ...
        mark.className = 'fdgb-checkbox-mark';
    ...
    function sampleTrimControls(channel) {
        ...
        wrap.className = 'fdgb-sample-trim-row';
    ...
    function sampleInput(channel, disabled = false) {
        const wrap = document.createElement('div');
        wrap.className = 'fdgb-sample-upload';
        const picker = document.createElement('label');
        picker.className = 'fdgb-upload-button';
    ...
    function soundfontCustomField(channel) {
        ...
        const picker = document.createElement('label');
        picker.className = 'fdgb-upload-button' + (isCustom ? '' : ' is-disabled');
        const input = document.createElement('input');
        input.type = 'file';
    ...
    function rollStepRect(step) {
        const label = els.pianoRoll.querySelector('.fdgb-bar-label[data-step="' + step + '"]');
        return label ? label.getBoundingClientRect() : null;
    }

    function rollPositionAtPointer(clientX) {
        const labels = Array.from(els.pianoRoll.querySelectorAll('.fdgb-bar-label[data-step]'));
    ...
    function renderRoll() {
        ...
        notes.forEach(note => {
            ...
            label.className = 'fdgb-note-label' + (isBlack ? ' is-black-key' : '');
            label.dataset.note = note;
            const key = document.createElement('span');
            key.className = 'fdgb-piano-key';
            const text = document.createElement('span');
            ...
            for (let step = 0; step < stepCount(); step += 1) {
                ...
                cell.className = 'fdgb-cell' + (isActiveNote ? ' is-on' : '');
    ...
    function renderPlaylistTools() {
        ...
        picker.className = 'fdgb-select fdgb-playlist-pattern-picker';
        const usedPatterns = usedPatternIndexes();
        ...
        dragButton.className = 'fdgb-playlist-pattern-source is-active';
    ...
    function renderMixer() {
        ...
        strip.className = 'fdgb-mixer-strip';
        const color = document.createElement('div');
        color.className = 'fdgb-mixer-strip-color';
        color.style.background = channel.color;
        const title = document.createElement('div');
        title.className = 'fdgb-mixer-strip-title';
        title.textContent = channel.name;
        const summary = document.createElement('div');
        summary.className = 'fdgb-mixer-strip-summary';
        ...
        if (!channel.effects.length) {
            ...
            empty.className = 'fdgb-empty-state';
        ...
        channel.effects.forEach((effect, index) => {
            const definition = effectDefinitions.get(effect.type);
            const card = document.createElement('div');
            card.className = 'fdgb-effect-card' + (effect.enabled ? '' : ' is-bypassed');

            const head = document.createElement('div');
            head.className = 'fdgb-effect-head';
            const name = document.createElement('div');
            name.className = 'fdgb-effect-name';
            name.textContent = definition ? definition.name : effect.type;
            const actions = document.createElement('div');
            actions.className = 'fdgb-effect-actions';
    ...
    function renderAutomation(updatePicker = true) {
        ...
        help.className = 'fdgb-automation-help';
        ...
        channel.automation.forEach((lane, index) => {
            ...
            renderedLanes += 1;
            const card = document.createElement('div');
            card.className = 'fdgb-automation-lane' + (lane.enabled ? '' : ' is-bypassed');

            const head = document.createElement('div');
            head.className = 'fdgb-automation-head';
            const title = document.createElement('div');
            title.className = 'fdgb-automation-title';
            title.textContent = target.label;
            const actions = document.createElement('div');
            actions.className = 'fdgb-effect-actions';

            const mode = document.createElement('select');
            mode.className = 'fdgb-select fdgb-automation-mode';
            ...
            grid.className = 'fdgb-automation-grid';
            ...
            footer.className = 'fdgb-automation-footer';
    ...
    function automationCell(channel, lane, target, step, patternIndex) {
        ...
        cell.className = 'fdgb-automation-cell' + (hasValue ? ' is-set' : '') + (!hasValue && resolvedValue !== null ? ' is-filled' : '');
        cell.type = 'button';
        cell.dataset.step = String(step);
        ...
        if (resolvedValue !== null && target.param.type !== 'select') {
            ...
            cell.style.setProperty('--fdgb-automation-fill', (Math.max(0, Math.min(1, ratio)) * 100) + '%');
        }
        ...
        cell.addEventListener('pointerdown', event => {
            ...
            const move = moveEvent => {
                ...
                const targetCell = element && element.closest ? element.closest('.fdgb-automation-cell') : null;
    ...
    function renderEffectPresets(channel, effect, definition) {
        ...
        const wrap = document.createElement('label');
        wrap.className = 'fdgb-effect-preset';
        const label = document.createElement('span');
        label.textContent = 'preset';
        const picker = document.createElement('select');
        picker.className = 'fdgb-select';
    ...
    function renderDefaultEffectControls(channel, effect, definition) {
        const controls = document.createElement('div');
        controls.className = 'fdgb-effect-controls';
        definition.params.forEach(param => {
    ...
    function renderSynthEditor() {
        ...
        ensureChannelSynth(channel);
        const head = document.createElement('div');
        head.className = 'fdgb-synth-editor-head';
        const title = document.createElement('div');
        title.className = 'fdgb-synth-editor-title';
        ...
        stage.className = 'fdgb-synth-stage';
        if (typeof definition.renderGui === 'function') {
            const custom = definition.renderGui({
                channel,
                definition,
    ...
    function renderSynthPresets(channel, definition) {
        ...
        if (!presets.length) return null;
        const wrap = document.createElement('label');
        wrap.className = 'fdgb-synth-preset';
        const label = document.createElement('span');
        label.textContent = 'preset';
        const picker = document.createElement('select');
        picker.className = 'fdgb-select';
    ...
    function renderDefaultSynthControls(channel, definition) {
        const controls = document.createElement('div');
        controls.className = 'fdgb-synth-controls';
        (definition.params || []).forEach(param => {
            const wrap = document.createElement('label');
            wrap.className = 'fdgb-field';
            const label = document.createElement('span');
    ...
    function showSampleZonePopup(event) {
        ...
        event.preventDefault();
        closeVelocityEditor();
        document.querySelectorAll('.fdgb-zone-popover').forEach(popover => popover.remove());

        const popover = document.createElement('div');
        popover.className = 'fdgb-zone-popover';
        const title = document.createElement('div');
        title.className = 'fdgb-zone-popover-title';
        title.textContent = 'create note zone';
        const keySelect = document.createElement('select');
        keySelect.className = 'fdgb-select';
        ...
        octaveSelect.className = 'fdgb-select';
        ...
        const hint = document.createElement('div');
        hint.className = 'fdgb-zone-popover-hint';
        hint.textContent = 'or press a keyboard key';
        const actions = document.createElement('div');
        actions.className = 'fdgb-confirm-actions';
        const cancel = document.createElement('button');
        cancel.className = 'fdgb-button';
        cancel.type = 'button';
        cancel.textContent = 'cancel';
        const create = document.createElement('button');
        create.className = 'fdgb-button fdgb-confirm-ok';
        create.type = 'button';
    ...
    function noteUnderPointer(clientY) {
        const labels = Array.from(els.pianoRoll.querySelectorAll('.fdgb-note-label[data-note]'));
        for (const label of labels) {
            const rect = label.getBoundingClientRect();
    ...
    function rollNoteAtPointer(clientX, clientY) {
        const target = document.elementFromPoint(clientX, clientY);
        const noteEl = target && target.closest('.fdgb-cell[data-note], .fdgb-note-label[data-note], .fdgb-note-block[data-note]');
    ...
    function rollStepAtPointer(clientX, clientY) {
        const target = document.elementFromPoint(clientX, clientY);
        const stepEl = target && target.closest('.fdgb-cell[data-step], .fdgb-bar-label[data-step], .fdgb-note-block[data-step]');
    ...
    function moveNoteBlockDom(step, previousNote, note, eventIndex) {
        const oldCell = els.pianoRoll.querySelector('.fdgb-cell[data-step="' + step + '"][data-note="' + previousNote + '"]');
        const newCell = els.pianoRoll.querySelector('.fdgb-cell[data-step="' + step + '"][data-note="' + note + '"]');
        const oldBlock = oldCell ? oldCell.querySelector('.fdgb-note-block[data-event-index="' + eventIndex + '"]') : null;
        const oldHandle = oldCell ? oldCell.querySelector('.fdgb-note-resize[data-event-index="' + eventIndex + '"]') : null;
        if (!oldBlock || !newCell) return false;
        oldCell.removeChild(oldBlock);
        if (oldHandle) oldCell.removeChild(oldHandle);
        if (!oldCell.querySelector('.fdgb-note-block')) oldCell.classList.remove('is-on');
        ...
        const slideText = oldBlock.querySelector('.fdgb-slide-text');
    ...
    function updateSlideDragLabel(block, text) {
        let label = block.querySelector('.fdgb-slide-text');
        if (!label) {
            label = document.createElement('span');
            label.className = 'fdgb-slide-text';
            block.append(label);
        }
    ...
    function openVelocityEditor(block, event) {
        ...
        editor.className = 'fdgb-velocity-popover';
        const label = document.createElement('span');
        label.textContent = 'velocity';
        const value = document.createElement('span');
        value.className = 'fdgb-velocity-value';
    ...
    function noteBlockAtEvent(event) {
        const direct = event.target.closest('.fdgb-note-block');
        if (direct && els.pianoRoll.contains(direct)) return direct;
        const cell = event.target.closest('.fdgb-cell');
        const cellBlock = cell ? cell.querySelector('.fdgb-note-block') : null;
    ...
    function handlePianoRollClick(event) {
        ...
        if (resizingNote || slidingNote || event.target.closest('.fdgb-note-resize')) return;
        const channel = selectedChannel();
        const pattern = getPattern(channel);
        const block = event.target.closest('.fdgb-note-block');
    ...
    function handlePianoRollPointerDown(event) {
        ...
        const handle = event.target.closest('.fdgb-note-resize');

        const emptyCell = event.target.closest('.fdgb-cell');
        if (emptyCell && els.pianoRoll.contains(emptyCell) && !event.target.closest('.fdgb-note-block, .fdgb-note-resize')) {
            event.preventDefault();
            event.stopPropagation();
            suppressRollClick = true;
        ...
        event.preventDefault();
        event.stopPropagation();
        const cell = handle.closest('.fdgb-cell');
        const block = cell ? cell.querySelector('.fdgb-note-block[data-step="' + handle.dataset.step + '"][data-note="' + handle.dataset.note + '"][data-event-index="' + handle.dataset.eventIndex + '"]') : null;
    ...
    els.pianoRoll.addEventListener('contextmenu', event => {
        if (event.target.closest('.fdgb-note-resize')) {
            event.preventDefault();
            return;
        }
        const block = noteBlockAtEvent(event);
    ...
    function paintPlaylistHead() {
        root.querySelectorAll('.fdgb-playlist .is-playing').forEach(el => el.classList.remove('is-playing'));
        root.querySelectorAll('.fdgb-playlist [data-bar="' + currentBar + '"]').forEach(el => el.classList.add('is-playing'));
    }
    ...
    function renderDemoMenu(items = [], failed = false) {
        ...
        if (failed) {
            els.demosMenu.append(menuNotice('fa-triangle-exclamation', 'demo list unavailable', 'could not read /tools/frdgbeats/demos'));
            return;
        }
        if (!items.length) {
            els.demosMenu.append(menuNotice('fa-folder-open', 'no demos found', 'add .frdgbeats files to /tools/frdgbeats/demos'));
            return;
        }
        items.forEach(item => {
            const button = document.createElement('button');
            button.className = 'fdgb-menu-option';
            button.type = 'button';
            button.innerHTML = '<i class="fa-solid fa-file-audio"></i><span><span class="fdgb-menu-title"></span><span class="fdgb-menu-desc">load demo project</span></span>';
            button.querySelector('.fdgb-menu-title').textContent = item.name;
    ...
    function renderPresetMenu(items = [], failed = false) {
        ...
        blank.className = 'fdgb-menu-option';
        blank.type = 'button';
        blank.innerHTML = '<i class="fa-solid fa-file"></i><span><span class="fdgb-menu-title">Empty</span><span class="fdgb-menu-desc">start from scratch</span></span>';
        ...
        if (failed) {
            els.presetsMenu.append(menuNotice('fa-triangle-exclamation', 'preset list unavailable', 'could not read /tools/frdgbeats/presets'));
            return;
        }
        if (!items.length) {
            els.presetsMenu.append(menuNotice('fa-folder-open', 'no presets found', 'add .frdgbeats files to /tools/frdgbeats/presets'));
            return;
        }
        items.forEach(item => {
            const button = document.createElement('button');
            button.className = 'fdgb-menu-option';
            button.type = 'button';
            button.innerHTML = '<i class="fa-solid fa-sliders"></i><span><span class="fdgb-menu-title"></span><span class="fdgb-menu-desc">start from preset</span></span>';
            button.querySelector('.fdgb-menu-title').textContent = item.name;
            button.addEventListener('click', async () => {
    ...
    async function loadPresetList() {
        els.presetsMenu.innerHTML = '';
        els.presetsMenu.append(menuNotice('fa-spinner', 'loading presets', 'checking /tools/frdgbeats/presets'));
        try {
    ...
    function menuNotice(icon, title, description) {
        ...
        item.className = 'fdgb-menu-option';
        item.type = 'button';
        item.disabled = true;
        item.innerHTML = '<i class="fa-solid ' + icon + '"></i><span><span class="fdgb-menu-title"></span><span class="fdgb-menu-desc"></span></span>';
        item.querySelector('.fdgb-menu-title').textContent = title;
        item.querySelector('.fdgb-menu-desc').textContent = description;
        return item;
    }

    async function loadDemoList() {
        els.demosMenu.innerHTML = '';
        els.demosMenu.append(menuNotice('fa-spinner', 'loading demos', 'checking /tools/frdgbeats/demos'));
        try {
    ...
    function renderSoundfontMenu(items = soundfontCatalog, failed = false) {
        ...
        custom.className = 'fdgb-menu-option';
        custom.type = 'button';
        custom.innerHTML = '<i class="fa-solid fa-upload"></i><span><span class="fdgb-menu-title">custom...</span><span class="fdgb-menu-desc">upload a SoundFont and use it for all SoundFont channels</span></span>';
        ...
        if (failed) {
            els.soundfontMenu.append(menuNotice('fa-triangle-exclamation', 'soundfont list unavailable', 'could not read /tools/frdgbeats/soundfonts'));
            return;
        }
        if (!items.length) {
            els.soundfontMenu.append(menuNotice('fa-folder-open', 'no soundfonts found', 'add .sf2 files to /tools/frdgbeats/soundfonts'));
            return;
        }
        items.forEach(item => {
            const button = document.createElement('button');
            button.className = 'fdgb-menu-option';
            button.type = 'button';
            button.innerHTML = '<i class="fa-solid fa-keyboard"></i><span><span class="fdgb-menu-title"></span><span class="fdgb-menu-desc">set all SoundFont channels</span></span>';
            button.querySelector('.fdgb-menu-title').textContent = item.name;
            button.addEventListener('click', async () => {
                closeMenus();
    ...
    function showView(view) {
        ...
        els.automationView.classList.toggle('fdgb-hidden', !isAutomation);
        els.waveformView.classList.toggle('fdgb-hidden', !isWaveform);
        els.synthView.classList.toggle('fdgb-hidden', !isSynth);
        els.rollView.classList.toggle('fdgb-hidden', isPlaylist || isMixer || isAutomation || isWaveform || isSynth);
    ...
    function closeMenus() {
        els.presetsMenu.classList.add('fdgb-hidden');
        els.demosMenu.classList.add('fdgb-hidden');
        els.soundfontMenu.classList.add('fdgb-hidden');
        els.importMenu.classList.add('fdgb-hidden');
        els.exportMenu.classList.add('fdgb-hidden');
    }

    function toggleMenu(menu) {
        const wasHidden = menu.classList.contains('fdgb-hidden');
        closeMenus();
        menu.classList.toggle('fdgb-hidden', !wasHidden);
    }
    ...
    els.openWiki.addEventListener('click', () => {
        window.location.href = '/tools/frdgbeats/wiki/';
    });
    ...
    els.newProject.addEventListener('click', event => {
        event.stopPropagation();
        const shouldLoad = els.presetsMenu.classList.contains('fdgb-hidden');
        toggleMenu(els.presetsMenu);
        if (shouldLoad) loadPresetList();
    });
    els.demosMenuButton.addEventListener('click', event => {
        event.stopPropagation();
        const shouldLoad = els.demosMenu.classList.contains('fdgb-hidden');
    ...
    document.addEventListener('click', event => {
        closeMenus();
        if (!event.target.closest('.fdgb-velocity-popover')) closeVelocityEditor();
    });
