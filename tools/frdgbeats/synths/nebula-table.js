(function () {
    ...
    function makeSlider(param, api, draw) {
        ...
        wrap.className = 'fdgb-nebula-knob';
        ...
        if (param.type === 'select') {
            ...
            select.className = 'fdgb-nebula-select';
...
.fdgb-nebula-title span:last-child {
...
.fdgb-nebula-filter .fdgb-nebula-screen {
    min-height: 90px;
}
.fdgb-nebula-controls {
    display: grid;
...
.fdgb-nebula-knob span,
.fdgb-nebula-knob strong {
    min-width: 0;
    overflow: hidden;
    text-overflow: ellipsis;
    white-space: nowrap;
...
.fdgb-nebula-knob input[type="range"] {
    position: absolute;
    inset: 0;
    width: 100%;
    height: 100%;
...
@media (max-width: 860px) {
    .fdgb-nebula-top { grid-template-columns: 1fr; }
    .fdgb-nebula-controls { grid-template-columns: repeat(4, minmax(58px, 1fr)); }
}
`,
        ...
        renderGui(api) {
            ...
            root.className = 'fdgb-nebula-panel';

            const top = document.createElement('div');
            top.className = 'fdgb-nebula-top';
            const oscA = document.createElement('section');
            const oscB = document.createElement('section');
            const filter = document.createElement('section');
            oscA.className = 'fdgb-nebula-module';
            oscB.className = 'fdgb-nebula-module';
            filter.className = 'fdgb-nebula-module fdgb-nebula-filter';
            oscA.innerHTML = '<div class="fdgb-nebula-title"><span>oscillator a</span><span>main wavetable</span></div>';
            oscB.innerHTML = '<div class="fdgb-nebula-title"><span>oscillator b</span><span>warp layer</span></div>';
            filter.innerHTML = '<div class="fdgb-nebula-title"><span>filter</span><span>drive stage</span></div>';

            const screenA = document.createElement('div');
            const screenB = document.createElement('div');
            const screenF = document.createElement('div');
            screenA.className = 'fdgb-nebula-screen';
            screenB.className = 'fdgb-nebula-screen';
            screenF.className = 'fdgb-nebula-screen';
            ...
            stripA.className = 'fdgb-nebula-strip';
            stripB.className = 'fdgb-nebula-strip';
            ...
            filterControls.className = 'fdgb-nebula-strip';
            ...
            controls.className = 'fdgb-nebula-controls';
