...
- The credits popup renders `/tools/frdgbeats/credits.md` with common Markdown blocks and inline formatting, including links, images, quotes, tables, rules, task lists, and fenced code.
