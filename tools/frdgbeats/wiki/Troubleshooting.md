...
The wiki reads `.md` files from `/tools/frdgbeats/wiki/`.

Internal links should point to page slugs like `[Quick Start](Quick-Start)`. The renderer turns those into `/tools/frdgbeats/wiki/?page=Quick-Start`.
